...
$ source setup.sh  (to set up environment for the virtual machine)
$ make
$ make sim
$ make vsim
...
The Makefile also includes two targets view viewing VCD files with
Synopsys DVE:
